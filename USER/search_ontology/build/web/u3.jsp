  ...
  <div id="inner_content">
    <div id="inner_main_column" style="width:960px;" >
      <h1 class="style48">About Schemes</h1>
        <table width="956" height="593" border="0">
        <tr>
          <td width="950" height="589"><FORM action="" method="post" >
            <table width="951" height="248" border="0">
              <tr>
                <td height="244"><table width="951" border="0" bgcolor="" align="center">
                  <tr>
                    <td width="945"><table width="967" height="39" border="0" >
                      <tr>
                        <td width="97" height="33" bgcolor="#0033FF"><div align="center" class="style63"><strong>Product Id </strong></div></td>
                        <td width="115" bgcolor="#0033FF"><div align="center" class="style63" ><strong>P Name </strong></div></td>
                        <td width="79" bgcolor="#0033FF"><div align="center" class="style63" ><strong>Price</strong></div></td>
                        <td width="129" bgcolor="#0033FF"><div align="center" class="style63" ><strong>Discount </strong></div></td>
                        <td width="98" bgcolor="#0033FF"><div align="center" class="style63" ><strong> Amount </strong></div></td>
						   <td width="121" bgcolor="#0033FF"><div align="center" class="style63" ><strong>No of Product</strong></div></td>
                        <td width="129" bgcolor="#0033FF"><div align="center" class="style63" ><strong>Total Amount </strong></div></td>
                        <td width="151" bgcolor="#0033FF"><div align="center" class="style63" ><strong>Paid Date </strong></div></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
