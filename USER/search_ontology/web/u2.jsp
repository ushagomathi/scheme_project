  ...
  <div id="inner_content">
    <div id="inner_main_column" style="width:960px;" >
      <h1 class="style48">About Schemes</h1>
        ...
        <tr>
          <td width="950" height="915"><FORM action="p1" method="post" >
            <table width="951" height="967" border="0">
              <tr>
                <td height="120"><table width="812" border="0" align="center">
                  ...
                  <tr>
                 <td width="348" height="165" align="center"><label>
                      <div align="center">
                        <input type="submit" name="s3" id="s3" value="WOMEN SCHEME "  style="width:250px; height:350px; background-color:#0099CC; font-style:normal ; font-size:24px;" />
                        </div>
                     </label></td>
                 <td width="385" align="center"><label>
                      <div align="center">
                        <input type="submit" name="s2" id="s2" value="EDUCATION COUNCILING"  style="width:350px; height:350px; background-color:#0099CC; font-style:normal ; font-size:24px;"/>
                        </div>
                 </label></td>
                    <td width="348" height="165" align="center"><label>
                      <div align="center">
                        <input type="submit" name="s3" id="s3" value="NGO SCHEME "  style="width:250px; height:350px; background-color:#0099CC; font-style:normal ; font-size:24px;" />
                        </div>
                     </label></td>
                  </tr>
