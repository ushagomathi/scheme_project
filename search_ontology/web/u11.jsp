      ...
      <h1 align="center"style="font-family: bold"> SEARCH YOUR DOMAIN</h1>
		...
		<table  border="0" align="center"  style=" height: 200px">
          ...
          <tr>
			...
			<table width="757" border="0" align="center" style="margin-top: -650px;margin-left: 210px">
  <tr>
    <td width="465"><label>
    ...
    <td width="10">&nbsp;</td>
    <td width="268"><label>
      <input type="submit" name="v2" value="search" style="width:150px; height:34px; cursor: pointer;background:#4CAF50; color: white; border: 0; font-size: large;" />
    </label></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
