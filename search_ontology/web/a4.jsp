...
<div id="wrapper">
  ...
  <div id="inner_content">
    <div id="inner_main_column" style="width:960px;" >
      <h1 class="style48"style="text-align:center;">ADD COLLEGE FOR COUNSELLING</h1>
   ...
   b=(String)request.getAttribute("b");
    ...
    %>
	<table width="600" height="638" border="0" align="center"  style="background-color: white ;box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); margin-top: 20px; border-collapse :collapse ; border-radius: 20px">
      <tr>
      ...
      <tr>
        <td height="551"><table align="center" width="463" height="421" border="0" cellpadding="1" cellspacing="1">
          <tr>
            <td width="171" height="30"><div align="right" class="style21 style5 style67">
  ...
  %> 
          <tr>
            <td height="35"><div align="right" class="style21 style6 style67">
          ...
          while (rs.next()) {
           ...
           %>
              <option><%=pro1%></option><%} %>
               ...
               <label>
               <input type="submit" name="s1" value="Enter" style="padding: 2px;background-color:#4CAF50;color:white; border: 0px; margin-bottom: 10px" />
               </label></td>    <%
        }
        catch(Exception e)
        {
		...
		%>
          <tr>
            <td height="34"><div align="right" class="style21 style7 style67">
			...
			%>
		     ...
		     <tr>
            <td height="46"><div align="right" class="style21 style67">
          ...
          <tr>
            <td height="36"><div align="right" class="style21 style8 style67">
          ...
          <tr>
            <td height="44"><div align="right" class="style21 style9 style67">
		    ...
		    <tr>
            <td height="44"><div align="right" class="style21 style10 style67">
            ...
            <td height="44"><div align="right" class="style21 style11 style67">
            ...
            <td height="42"><div align="right" class="style21 style12 style67">
		    ...
		    <tr>
            <td height="46"><div align="right" class="style21 style13 style67">
		    ...
		    <tr>
            <td height="46"><div align="right" class="style21 style14 style67">
              <div align="left">Department <span class="style24 style22">*</span></div>
            </div></td>
            <td>&nbsp;</td>
            <td><span class="style23"><input type="text"  id="a10" name="a10" style="width:180px" class="displayValue" onChange="return val_zero('a10','err_a10');"  onBlur="return txt_empty('a10','err_a10',' Should Not Be Blank');">&nbsp;&nbsp;<span id="err_a10"></span>
		      ...
		      <tr>
            <td height="46"><div align="right" class="style21 style15 style67">
              <div align="left">No Of Seats <span class="style24 style22">*</span></div>
            </div></td>
            <td>&nbsp;</td>
            <td><span class="style23"><input type="text"  id="a11" name="a11" style="width:180px" class="displayValue" onChange="return val_zero('a11','err_a11');"  onBlur="return txt_empty('a11','err_a11',' Should Not Be Blank');">&nbsp;&nbsp;<span id="err_a11"></span>
		     ...
		     <tr>
            <td height="46"><div align="right" class="style21 style16 style67">
              <div align="left">Department <span class="style24 style22">*</span></div>
            </div></td>
            <td>&nbsp;</td>
            ...
            <td height="46"><div align="right" class="style21 style17 style67">
              <div align="left">No of Seats <span class="style24 style22">*</span></div>
            </div></td>
            <td>&nbsp;</td>
            ...
            <td height="46"><div align="right" class="style21 style18 style67">
              <div align="left">Department <span class="style24 style22">*</span></div>
            </div></td>
            <td>&nbsp;</td>
            <td><span class="style23"><input type="text"  id="a14" name="a14" style="width:180px" class="displayValue" onChange="return val_zero('a14','err_a14');"  onBlur="return txt_empty('a14','err_a14',' Should Not Be Blank');">&nbsp;&nbsp;<span id="err_a14"></span>
		     ...
		     <tr>
            <td height="46"><div align="right" class="style21 style19 style67">
              <div align="left">No of Seats <span class="style24 style22">*</span></div>
            </div></td>
            <td>&nbsp;</td>
            <td><span class="style23"><input type="text"  id="a15" name="a15" style="width:180px" class="displayValue" onChange="return val_zero('a15','err_a15');"  onBlur="return txt_empty('a15','err_a15',' Should Not Be Blank');">&nbsp;&nbsp;<span id="err_a15"></span>
		     ...
		     <tr>
            <td height="46"><div align="right" class="style21 style20 style67">
              <div align="left">Department <span class="style24 style22">*</span></div>
            </div></td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td height="55"><span class="style67"></span></td>
            <td>&nbsp;</td>
            <td> <label for="label2"></label>
              <input type="submit" name="s2" style="padding: 10px;background-color: #4CAF50;color:white; border: 0px; border-radius:8px; margin-bottom: 10px" value="Submit" class="buttons"
