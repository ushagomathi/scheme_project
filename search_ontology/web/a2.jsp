...
<div id="wrapper">
  ...
  <div id="inner_content">
    ...
    <!--  <h1 class="style48">About Best Marketing Company</h1> -->
      <table width="914" border="0" align="center">
  <tr>
    <td width="908" height="56">HAI ADMIN ,</td>
  </tr>
  <tr>
...
<%
            ...
            <table width="891" height="518" border="0">
              <tr>
                <td width="885" height="514" align="center"><table width="510" border="0">
                    <tr>
                      <td width="504" height="31" align="center" ><span class="style63">ADD SCHEMES</span></td>
                    </tr>
                    <tr>
 ...
 int v,v1,v2=0;
    ...
    if(rs.next())
	 ...
	 %>
                        <tr>
                            <td width="195" height="31" style="text-align: left"><h3 class="style67"><span class="style3">Scheme Id </span></h3></td>
                          <td width="10">&nbsp;</td>
	...
	%>
                          <tr>
                            <td height="39" style="text-align: left"><h3 class="style67"><span class="style3">Scheme Name </span></h3></td>
                            <td>&nbsp;</td>
                            <td align="left"><label>
...
onchange="return val_zero('a3','err_a3);"
                          ...
                          <tr>
                            <td height="34" style="text-align: left"><h3 class="style67"><span class="style3">Scheme image </span></h3></td>
                            <td>&nbsp;</td>
                            <td align="left"><label>
                          ...
                          <tr>
                            <td height="38" style="text-align: left"><h3 class="style67"><span class="style3">Apply Price</span></h3></td>
                            <td>&nbsp;</td>
                            <td align="left"><label>
