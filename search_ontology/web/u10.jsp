...
<div id="wrapper">
  ...
  <tr>
    <td><table width="896" border="0" style="background-color: white ; width: 1000px;box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); margin-top: 20px; border-collapse :collapse ; border-radius: 20px">			               
      <%
...
<%
         if (rs.next()) {
           ...
           %>
             <tr>
    <td width="908" height="41" align="center" ><span class="style22" style="font-size: 30px">Welcome To <%=rs.getString(3)%> College</span></td>
  </tr>
	 <tr>
        <td width="500"><strong>About Us </strong></td>
      </tr>
	   <tr>
      ...
      <tr>
        <td height="141"><table width="737" border="0" align="center" bgcolor=whitesmoke>
      <tr>
        <td height="35" align='center'><strong>DEPARTMENT AND SEATS AVAILABLE: <span class="style28"><%=a%></span></strong></td>
      </tr>
      <tr>
  ...
  <tr>
    <td width="195">&nbsp;</td>
    <td width="50"><input type="submit" name="s1" value="Submit" style="padding: 10px;background-color: #4CAF50;color:white; border: 0px; border-radius:8px; margin-bottom: 10px"></td>
    <td width="50"><input type="reset" name="s2" value="Cancel" style="padding: 10px;background-color: #4CAF50;color:white; border: 0px; border-radius:8px; margin-bottom: 10px"></td>
    <td width="196">&nbsp;</td>
  </tr>
</table></td>
      </tr>
