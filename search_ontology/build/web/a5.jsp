...
<div id="wrapper">
  ...
  <div id="inner_content">
    <div id="inner_main_column" style="width:960px;" >
        ...
        <tr>
          <td width="936" height="35" align="center" bgcolor="#0066CC"><span class="style3 style1  style65"><strong>User Details </strong></span></td>
        </tr>
        <tr>
  ...
  <tr>
		      ...
		      <td width="172" align="center"><span class="style4"><strong>Address</strong></span></td>
                      <td width="165" align="center"><span class="style4" style="text-align:center;"><strong>Mobile</strong></span></td>
            </tr>
</table>
    ...
    while(rs.next())
	 ...
	 %>
            <tr>
              ...
              <td width="157"align="center"><%=rs.getString(6)%></td>
          <td width="150"align="center"><%=rs.getString(5)%></td>
              <td width="198" align="center"><%=rs.getString(7)%></td>
              <td width="194"align="center"><%=rs.getString(10)%></td>
            </tr><%
