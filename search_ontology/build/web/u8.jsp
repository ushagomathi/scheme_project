                      ...
                      <td width="772" height="304"  align="center"><table width="751" border="0">
                          <tr>
                            <td width="405" height="298" ><table width="405" border="0" cellspacing="4px">
                                <tr>
                                  <td width="159" height="32"><span class="style71">Scheme Id </span></td>
                                  <td width="7">&nbsp;</td>
                                  <td width="219"><label>
                                ...
                                <tr>
                                  <td height="39"><span class="style71">Scheme Name </span></td>
                                  <td>&nbsp;</td>
                                  <td><label>
                                ...
                                <tr>
                                  ...
                                  <td height="68"><span class="style71">Comments</span></td>
                                  <td>&nbsp;</td>
                                  <td><span class="style50">
                                    <label>
                                ...
                                <tr>
                                  ...
                                  <td>&nbsp;</td>
                                  <td><label>
                                    <input name="s1" type="submit"  value="Submit" style="padding: 10px;background-color:#4CAF50;color:white; border: 0px; border-radius:8px; margin-bottom: 10px" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="reset" name="s2" value="Cancel" style="padding: 10px;background-color:#4CAF50;color:white; border: 0px; border-radius:8px; margin-bottom: 10px" />
                                  </label></td>
                                </tr>
