...
<body id="inner" style="background-color: #f4f4f4">
<div id="wrapper">
  ...
  <!--header ends-->
  <div id="inner_content" style="background-color: #f4f4f4">
  ...
  a=(String)request.getAttribute("a");
    ...
    %>
  	  <table width="66%" border="0" align="center"style="background-color: white ;box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); margin-top: 20px; border-collapse :collapse ; border-radius: 20px" >
        <tr>
          <td width="93%" style="padding-top: 20px" height="49" align="center" ><span class="style8 style62 ">REGISTRATION FORM </span></td>
        </tr>
        <tr>
        ...
        out.println(e);
            ...
            <tr>
             ...
             <tr>
                ...
                <td>&nbsp;</td>
              <td><div align="left" style="margin-top: 30px">
                <p>
                  <label>
            ...
            <tr>
              ...
              <input  type="submit" name="Submit" value="Submit" style="padding: 10px;background-color: #007bff;color:white; border: 0px; border-radius:8px; margin-bottom: 10px" class="buttons" onclick="return validatePage('a1|a2|a3|a4|a5|a6|a7|a8|a9|a10'	 ,'err_a1|err_a2|err_a3|err_a4|err_a5|err_a6|err_a7|err_a8|err_a9|err_a10'
			 ,'Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank');"  />
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="submit" name="Submit2" value="Cancel" style="padding: 10px;background-color: whitesmoke;color: #007bff; border: 0px; border-radius:8px; margin-bottom: 10px"/>
                  </div>
              </label></td>      <td>&nbsp;</td>
            </tr>
          </table></td>
